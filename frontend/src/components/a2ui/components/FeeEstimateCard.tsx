  ...
  return (
    <div className={cn(
      ...
      {data.packages && data.packages.length > 0 && (
        <div className="px-4 py-3 border-b border-gray-100">
          <p className="text-xs font-medium text-gray-600 mb-2">选择服务套餐</p>
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    {pkg.originalPrice && (
                      <span className="text-[10px] text-gray-400 line-through ml-1">¥{pkg.originalPrice.toLocaleString()}</span>
                    )}
                  </div>
                </div>
                <p className="text-[10px] text-gray-500 mt-1">{pkg.description}</p>
      ...
      <div className="px-4 py-3">
        <p className="text-xs font-medium text-gray-600 mb-2">费用明细</p>
        <div className="space-y-2">
          {data.items.map((item) => (
            ...
            >
              ...
              <span className={cn(
                'text-xs font-medium',
                selectedItems.has(item.id) ? 'text-gray-800' : 'text-gray-400',
              )}>
        ...
        <div className="mt-3 pt-3 border-t border-gray-200 flex items-center justify-between">
          <span className="text-xs font-medium text-gray-600">{data.total.label || '合计'}</span>
          <div className="text-right">
