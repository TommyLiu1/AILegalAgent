  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        <div className="w-8 h-8 bg-[#FFF8ED] rounded-xl flex items-center justify-center">
          <Zap className="w-4 h-4 text-[#FF9500]" />
        </div>
        <div>
          <h3 className="font-semibold text-[#1C1C1E]">Token 消耗</h3>
          <p className="text-xs text-[#8E8E93]">AI 调用统计</p>
        </div>
      </div>

      <div className="grid grid-cols-2 gap-3">
        <div className="bg-[#F2F2F7] rounded-xl p-3">
          <p className="text-xs text-[#8E8E93] mb-1">总 Token</p>
          <p className="text-lg font-bold text-[#1C1C1E]">
            {(totalTokens / 1000).toFixed(1)}K
          </p>
        </div>
        <div className="bg-[#F2F2F7] rounded-xl p-3">
          <p className="text-xs text-[#8E8E93] mb-1">总调用次数</p>
          <p className="text-lg font-bold text-[#1C1C1E]">
            {totalCalls}
          </p>
        </div>
