    ...
    <div className="h-full flex flex-col bg-card">
      ...
      <div className="border-b border-border px-6 py-4 bg-card">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            {showAnnotations && (
              <div className="flex items-center gap-2 px-3 py-1.5 bg-warning/10 rounded-xl border border-warning">
      ...
      {/* Status Bar */}
      <div className="border-t border-border px-6 py-2 bg-card flex items-center justify-between text-xs text-muted-foreground">
